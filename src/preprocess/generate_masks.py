...
basic_mask_dicts = [
	{'NameStrings' : ['aorta'], 'InvalidNStrings' : ['wall', 'blood', 'shrink', 'grow', 'crop'], 'GV' : True, 'Stationary' : False, 'CardiacOutput' : 1.},
	{'NameStrings' : ['aorta', 'blood'], 'InvalidNStrings' : ['wall', 'shrink', 'grow', 'crop'], 'GV' : True, 'Stationary' : False, 'CardiacOutput' : 1.},
	{'NameStrings' : ['aorta', 'wall'], 'InvalidNStrings' : ['blood', 'shrink', 'grow', 'crop'], 'GV' : True, 'Stationary' : False, 'CardiacOutput' : 1.},
	{'NameStrings' : ['aorta', 'shrink', '1'], 'InvalidNStrings' : ['blood', 'wall', 'grow', '3', 'crop'], 'GV' : True, 'Stationary' : False, 'CardiacOutput' : 1.},
	{'NameStrings' : ['aorta', 'shrink', '3'], 'InvalidNStrings' : ['blood', 'wall', 'grow', '1', 'crop'], 'GV' : True, 'Stationary' : False, 'CardiacOutput' : 1.},
	{'NameStrings' : ['aorta', 'grow'], 'InvalidNStrings' : ['blood', 'wall', 'shrink', 'crop'], 'GV' : True, 'Stationary' : False, 'CardiacOutput' : 1.},
